...
exports.isP2SHAddress = exports.isTaprootAddress = exports.mapUtxos = exports.generateTxidFromHash = exports.btcToSats = exports.satToBtc = exports.toXOnly = void 0;
...
async function mapUtxos(utxosFromMempool) {
    ...
    for (const utxoFromMempool of utxosFromMempool) {
        ret.push({
            ...
            tx: bitcoin.Transaction.fromHex(await (0, mempool_1.getRawTxHex)(utxoFromMempool.txid)),
        });
    }
    return ret;
}
...
exports.isTaprootAddress = isTaprootAddress;
